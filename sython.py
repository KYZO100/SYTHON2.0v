...
c = requests.session()
bot_username = '@zmmbot'
bot_usernamee = '@EEObot'
bot_usernameee = '@DamKombot'
bot_usernameeee = '@rshaqchibot'
...
`/point2` : X تجميع نقاط بوت المليار
`/point3` :  تجميع نقاط بوت دعمكم 
`/point4` :   تجميع نقاط بوت رشقچي
`/point5` : تجميع نقاط بوت هايبر

╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍

`/gift1` :   تجميع هدية المليار
`/gift2` : X تجميع هدية المليار 
`/gift3` :  تجميع هدية دعمكم
`/gift4` :   تجميع هدية رشقچي
`/gift5` : تجميع هدية هايبر 
...
@sython1.on(events.NewMessage(outgoing=False, pattern='/gift1'))
async def OwnerStart(event):
    sender = await event.get_sender()
    if sender.id == ownerhson_id:
...
@sython1.on(events.NewMessage(outgoing=True, pattern=".تجميع هايبر"))
async def _(event):
